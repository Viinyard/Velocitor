...
import pro.vinyard.velocitor.custom.DirectoryInput;
...
public class EnvironnementShellComponent extends AbstractShellComponent {
    ...
    public String setHomeDirectory() {
        ...
        return "Home directory set to " + environmentManager.getHomeDirectory();
    }
    ...
    public String init() {
        return environmentManager.initialize();
    }
