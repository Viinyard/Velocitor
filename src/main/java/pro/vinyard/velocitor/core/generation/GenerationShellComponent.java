package pro.vinyard.velocitor.core.generation;
...
import pro.vinyard.velocitor.core.model.ModelManager;
import pro.vinyard.velocitor.core.model.entities.*;
...
public class GenerationShellComponent extends CustomAbstractShellComponent {
    ...
    public void generate() throws VelocitorException, IOException {
        ...
        Model model = this.modelManager.loadModel(modelName);
    ...
    public Object prompt(PromptType promptType, VelocityContext velocityContext) {
        ...
        return switch (promptType) {
            ...
            case StringInput e ->
                    this.stringInput(templated.apply(e.getValue()), templated.apply(e.getDefaultValue().getContent()), e.isMasked());
